...
function addListener()
{
    ...
    document.getElementById("teamScore3").disabled = true;
    document.getElementById("teamScore4").disabled = true;
    ...
    NewScore  = parseInt(localStorage.getItem("team1score")) || 0;
    NewScore2 = parseInt(localStorage.getItem("team2score")) || 0;
    NewScore3 = parseInt(localStorage.getItem("team3score")) || 0;
    NewScore4 = parseInt(localStorage.getItem("team4score")) || 0;
    ...
    if(math1 == "selected") document.getElementById("100math").disabled = true;
    if(math2 == "selected") document.getElementById("200math").disabled = true;
    if(math3 == "selected") document.getElementById("300math").disabled = true;
    if(math4 == "selected") document.getElementById("400math").disabled = true;
    if(math5 == "selected") document.getElementById("500math").disabled = true;

    if(science1 == "selected") document.getElementById("100science").disabled = true;
    if(science2 == "selected") document.getElementById("200science").disabled = true;
    if(science3 == "selected") document.getElementById("300science").disabled = true;
    if(science4 == "selected") document.getElementById("400science").disabled = true;
    if(science5 == "selected") document.getElementById("500science").disabled = true;

    if(history1 == "selected") document.getElementById("100history").disabled = true;
    if(history2 == "selected") document.getElementById("200history").disabled = true;
    if(history3 == "selected") document.getElementById("300history").disabled = true;
    if(history4 == "selected") document.getElementById("400history").disabled = true;
    if(history5 == "selected") document.getElementById("500history").disabled = true;

    if(geography1 == "selected") document.getElementById("100geography").disabled = true;
    if(geography2 == "selected") document.getElementById("200geography").disabled = true;
    if(geography3 == "selected") document.getElementById("300geography").disabled = true;
    if(geography4 == "selected") document.getElementById("400geography").disabled = true;
    if(geography5 == "selected") document.getElementById("500geography").disabled = true;
}
...
function Mainmenu()
{
    ...
    localStorage.removeItem("team3score");
    localStorage.removeItem("team4score");
    localStorage.removeItem("NumScore");

    window.location.href = "menu.html";
}


function Math100(){ window.location.href = "math100.html"; }
function Math200(){ window.location.href = "math200.html"; }
function Math300(){ window.location.href = "math300.html"; }
function Math400(){ window.location.href = "math400.html"; }
function Math500(){ window.location.href = "math500.html"; }

function Science100(){ window.location.href = "science100.html"; }
function Science200(){ window.location.href = "science200.html"; }
function Science300(){ window.location.href = "science300.html"; }
function Science400(){ window.location.href = "science400.html"; }
function Science500(){ window.location.href = "science500.html"; }

function History100(){ window.location.href = "history100.html"; }
function History200(){ window.location.href = "history200.html"; }
function History300(){ window.location.href = "history300.html"; }
function History400(){ window.location.href = "history400.html"; }
function History500(){ window.location.href = "history500.html"; }

function Geography100(){ window.location.href = "geography100.html"; }
function Geography200(){ window.location.href = "geography200.html"; }
function Geography300(){ window.location.href = "geography300.html"; }
function Geography400(){ window.location.href = "geography400.html"; }
function Geography500(){ window.location.href = "geography500.html"; }
...
function AddScore()
{
    ...
    document.getElementById("teamScore").value = NewScore;
    localStorage.setItem("team1score", NewScore);
}
...
function AddScore2()
{
    ...
    document.getElementById("teamScore2").value = NewScore2;
    localStorage.setItem("team2score", NewScore2);
}
...
function AddScore3()
{
    ...
    document.getElementById("teamScore3").value = NewScore3;
    localStorage.setItem("team3score", NewScore3);
}
...
function AddScore4()
{
    ...
    document.getElementById("teamScore4").value = NewScore4;
    localStorage.setItem("team4score", NewScore4);
}
